...
<task type="auto">
  ...
  <done>PhotoSwipe lightbox closes before page transitions. Hero carousel pauses during transitions. Both components handle View Transitions gracefully without visual artifacts.</done>
</task>
